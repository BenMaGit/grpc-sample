 ...
 * they want.
 *
 * @generated from message hellostreamingworld.HelloRequest
 */
export class HelloRequest extends Message<HelloRequest> {
  ...
  /**
   * @generated from field: string num_greetings = 2;
   */
  numGreetings = "";
  ...
  static readonly typeName = "hellostreamingworld.HelloRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "name", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "num_greetings", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);
 ...
 *
 * @generated from message hellostreamingworld.HelloReply
 */
export class HelloReply extends Message<HelloReply> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "hellostreamingworld.HelloReply";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
